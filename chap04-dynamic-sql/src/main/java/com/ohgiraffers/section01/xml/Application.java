...
public class Application {
    ...
    private static void foreachSubMenu(){
        ...
        do{
            ...
            switch (no){
                case 1 :
                    menuService.searchMenuByRandomMenuCode(createRandomMenuCodeList());break;
                case 9 : return;
            }
        }while(true);
    }
    ...
    private static Map<String, Object> inputChangeInfo() {
        Scanner scr = new Scanner(System.in);
        System.out.print("변경할 메뉴 코드를 입력 해주세요 : ");
        int code = scr.nextInt();
        System.out.print("변경할 메뉴 이름을 입력 해주세요 : ");
        scr.nextLine();
        String name = scr.nextLine();
        System.out.print("변경할 카테고리 코드를 입력 해주세요 : ");
        int categoryCode = scr.nextInt();
        System.out.print("판배 여부를 결정 해주세요 ( Y, N )");
        scr.nextLine();
